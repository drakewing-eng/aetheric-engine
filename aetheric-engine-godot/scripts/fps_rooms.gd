...
const ROOMS := {
	...
	"entrance_hall": {
		...
		"props": [
			...
			{"kind": "plant", "pos": [2.0, 0.0, -3.8], "scale": 0.9},
			{"kind": "plant", "pos": [-5.0, 0.0, 3.2], "scale": 1.0, "tall": true},
		],
		"doors": [
			{
				"label": "Drawing Room",
	...
	"conservatory": {
		...
		"props": [
			# Mix: short palm cards (grounded) + mesh canopy plants (true 3D pots, no float)
			{"kind": "plant", "pos": [2.5, 0.0, -2.2], "scale": 1.2, "tall": true,
				"texture": "res://assets/props/plants/plant_palm.png", "width": 0.95, "height": 1.35},
			{"kind": "plant", "pos": [-2.8, 0.0, -2.5], "scale": 1.25, "tall": true,
				"texture": "res://assets/props/plants/plant_palm.png", "width": 1.0, "height": 1.4},
			{"kind": "plant", "pos": [3.2, 0.0, 0.5], "scale": 1.15, "tall": true},
			{"kind": "plant", "pos": [-3.0, 0.0, 1.2], "scale": 1.05},
			{"kind": "plant", "pos": [0.5, 0.0, -2.8], "scale": 1.15, "tall": true,
				"texture": "res://assets/props/plants/plant_palm.png", "width": 0.9, "height": 1.3},
			{"kind": "plant", "pos": [-1.0, 0.0, -1.5], "scale": 0.95},
			{"kind": "plant", "pos": [1.2, 0.0, 2.0], "scale": 0.9,
				"texture": "res://assets/props/plants/plant_palm.png", "width": 0.7, "height": 1.05},
			{"kind": "plant", "pos": [-2.0, 0.0, 2.2], "scale": 0.9},
			{"kind": "plant", "pos": [3.0, 0.0, -1.2], "scale": 0.85},
			{"kind": "plant", "pos": [-3.3, 0.0, -0.8], "scale": 1.1, "tall": true},
			...
			{"kind": "plant", "pos": [0.0, 0.0, -0.6], "scale": 0.8},
			{"kind": "plant", "pos": [3.5, 0.0, 2.5], "scale": 0.95},
			{"kind": "plant", "pos": [-3.5, 0.0, 2.4], "scale": 1.0, "tall": true,
