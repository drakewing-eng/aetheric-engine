...
const ROOMS := {
	"drawing_room": {
		...
		"props": [
			...
			# Flanking sofa: UNIQUE mesh tables (never clone same billboard twice)
			{"kind": "side_table", "pos": [1.55, 0.0, -3.15], "yaw": -15.0, "seed": 0},
			{"kind": "side_table", "pos": [-1.55, 0.0, -3.15], "yaw": 15.0, "seed": 4},
			# Mesh seating kept clear of billboard sofa (no clip-under)
			{"kind": "armchair", "pos": [2.85, 0.0, 1.6], "yaw": -125.0, "fabric": Color(0.42, 0.14, 0.16)},
			{"kind": "fireplace", "pos": [2.6, 0.0, -4.62], "yaw": 0.0},
			# Library cases: different seed → wood + book mix (uniqueness)
			...
			{"kind": "side_table", "pos": [-2.0, 0.0, 1.9], "yaw": 10.0, "seed": 1},
			# Ottoman in FRONT of sofa (olive velvet, seed 0 square tufted)
			{"kind": "ottoman", "pos": [0.15, 0.0, -2.55], "yaw": 8.0, "seed": 0,
			...
			{"kind": "side_table", "pos": [3.0, 0.0, 1.2], "yaw": 15.0, "seed": 5},
			{"kind": "side_table", "pos": [-0.8, 0.0, 0.5], "yaw": -5.0, "seed": 8},
			# Novel MUST/SHOULD: letters + tea tray
			{"kind": "letter_stack", "pos": [2.95, 0.72, 0.25], "yaw": -20.0, "seed": 1},
			{"kind": "tea_tray", "pos": [-0.8, 0.68, 0.5], "yaw": 10.0, "seed": 0},
