...
const ROOMS := {
	"drawing_room": {
		...
		"props": [
			...
			{"kind": "wall_sconce", "pos": [1.5, 0.0, -4.7], "yaw": 0.0, "height": 2.25},
			{"kind": "stool", "pos": [0.8, 0.0, 2.0], "yaw": -15.0},
			{"kind": "copper_pot", "pos": [-3.5, 0.0, 1.5], "scale": 0.5},
			{"kind": "crate", "pos": [3.5, 0.0, 2.2], "scale": 0.5},
			{"kind": "stool", "pos": [-1.8, 0.0, 2.5], "yaw": 50.0},
			{"kind": "plant", "pos": [3.6, 0.0, -3.2], "scale": 0.85,
				"texture": "res://assets/props/plants/plant_palm.png", "width": 0.95, "height": 1.1},
			{"kind": "copper_pot", "pos": [2.6, 0.0, 2.4], "scale": 0.5},
			{"kind": "crate", "pos": [-3.5, 0.0, 2.3], "scale": 0.45},
		],
		"doors": [
			{
				"label": "Entrance Hall",
	...
	"conservatory": {
		...
		"props": [
			...
			{"kind": "copper_pot", "pos": [0.4, 0.0, -1.5], "scale": 0.6},
			{"kind": "copper_pot", "pos": [-0.5, 0.0, 1.0], "scale": 0.5},
