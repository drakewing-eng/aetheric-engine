...
const ROOMS := {
	"drawing_room": {
		...
		"props": [
			...
			# Loop 157: solid mesh wing (velvet red — not wood-classified)
			{"kind": "armchair", "pos": [-2.9, 0.0, 2.0], "yaw": 40.0,
				"fabric": Color(0.55, 0.12, 0.16)},
			...
			# Loop 136: soft dust in sunbeams
			{"kind": "dust_motes", "pos": [0.0, 0.0, 0.0], "amount": 32},
			{"kind": "dust_motes", "pos": [2.0, 0.0, -2.5], "amount": 20},
			...
			{"kind": "plant", "pos": [-3.5, 0.0, 3.5], "scale": 0.7, "seed": 2,
			...
			{"kind": "plant", "pos": [2.3, 0.0, 3.6], "scale": 0.75, "seed": 4,
				"texture": "res://assets/props/plants/plant_fern.png", "width": 0.7, "height": 0.9},
	...
	"entrance_hall": {
		...
		"props": [
			...
			{"kind": "dust_motes", "pos": [0.0, 0.0, 0.0], "amount": 24},
			...
			{"kind": "plant", "pos": [3.4, 0.0, 4.0], "scale": 0.72, "seed": 2,
			...
			{"kind": "plant", "pos": [-5.9, 0.0, -4.0], "scale": 0.72, "seed": 5,
				"texture": "res://assets/props/plants/plant_fern.png", "width": 0.65, "height": 0.8},
	...
	"gallery": {
		...
		"props": [
			...
			{"kind": "dust_motes", "pos": [0.0, 0.0, -1.0], "amount": 28},
			...
			{"kind": "chair", "pos": [-4.3, 0.0, -1.5], "yaw": -90.0, "seed": 2,
				"fabric": Color(0.2, 0.3, 0.2)},
	...
	"morning_room": {
		...
		"props": [
			...
			# Loop 157: solid mesh sage wing (velvet green path)
			{"kind": "armchair", "pos": [-2.0, 0.0, -0.6], "yaw": 55.0,
				"fabric": Color(0.24, 0.34, 0.24)},
			...
			{"kind": "plant", "pos": [-3.0, 0.0, -2.9], "scale": 0.7, "seed": 2,
				"texture": "res://assets/props/plants/plant_fern.png", "width": 0.65, "height": 0.75},
			{"kind": "plant", "pos": [3.25, 0.0, -0.6], "scale": 0.72, "seed": 3,
				"texture": "res://assets/props/plants/plant_fern.png", "width": 0.68, "height": 0.85},
			{"kind": "plant", "pos": [-3.1, 0.0, 2.2], "scale": 0.8, "seed": 1,
				"texture": "res://assets/props/plants/plant_palm.png", "width": 0.75, "height": 1.0},
			...
			# Loop 169: corner plant only (was mid-wall scrap at scale 0.5)
			{"kind": "plant", "pos": [-3.0, 0.0, -2.5], "scale": 0.7, "seed": 4,
				"texture": "res://assets/props/plants/plant_fern.png", "width": 0.65, "height": 0.8},
			...
			{"kind": "plant", "pos": [2.2, 0.0, 3.1], "scale": 0.7, "seed": 5,
				"texture": "res://assets/props/plants/plant_fern.png", "width": 0.65, "height": 0.8},
			...
			# Loop 169: no mid-rug micro fern (was green scrap on carpet FOV)
		],
		"doors": [
			{
				"label": "Entrance Hall",
	...
	"workshop": {
		...
		"features": [
			...
			{"kind": "window", "pos": [-4.85, 1.9, 0.0], "yaw": 90.0, "width": 1.3, "height": 1.8, "seed": 6,
				"view": "res://assets/rooms/textures/views/view_garden2.jpg"},
		...
		"props": [
			...
			{"kind": "chalk_board", "pos": [2.2, 0.0, -4.1], "yaw": 0.0, "seed": 0},
			{"kind": "chalk_board", "pos": [-4.3, 0.0, -3.2], "yaw": 90.0, "seed": 3},
			{"kind": "workbench", "pos": [-2.2, 0.0, -2.6], "yaw": 0.0, "width": 2.9, "seed": 0},
			{"kind": "dust_motes", "pos": [0.0, 0.0, -1.0], "amount": 20},
			...
			{"kind": "tool_rack", "pos": [4.3, 0.0, 2.2], "yaw": -90.0, "seed": 3},
			...
			{"kind": "tool_shelf", "pos": [-4.2, 0.0, -3.5], "yaw": 90.0, "width": 1.2, "height": 1.7, "seed": 4},
			{"kind": "stool", "pos": [-1.4, 0.0, -1.6], "yaw": 25.0, "seed": 0},
			{"kind": "stool", "pos": [1.4, 0.0, -1.4], "yaw": -20.0, "seed": 1},
			{"kind": "stool", "pos": [0.3, 0.0, -3.0], "yaw": 10.0, "seed": 2},
			...
			{"kind": "crate", "pos": [-3.0, 0.0, -3.6], "scale": 0.65, "seed": 1},
	...
	"conservatory": {
		...
		"props": [
			# Loop 150: thin mid-floor clutter — plants + benches + urns as heroes; clear stone path
			# Perimeter palms/ferns
			{"kind": "plant", "pos": [2.9, 0.0, -2.5], "scale": 1.15, "seed": 0,
				"texture": "res://assets/props/plants/plant_palm.png", "width": 1.05, "height": 1.45},
			{"kind": "plant", "pos": [-2.9, 0.0, -2.5], "scale": 1.0, "seed": 1,
				"texture": "res://assets/props/plants/plant_fern.png", "width": 0.95, "height": 1.1},
			{"kind": "plant", "pos": [3.4, 0.0, 0.5], "scale": 0.95, "seed": 2,
				"texture": "res://assets/props/plants/plant_palm.png", "width": 0.9, "height": 1.2},
			{"kind": "plant", "pos": [-3.4, 0.0, 0.5], "scale": 0.8, "seed": 3,
				"texture": "res://assets/props/plants/plant_fern.png", "width": 0.75, "height": 0.9},
			{"kind": "plant", "pos": [2.8, 0.0, 2.7], "scale": 0.75, "seed": 4,
				"texture": "res://assets/props/plants/plant_fern.png", "width": 0.7, "height": 0.8},
			{"kind": "plant", "pos": [-2.8, 0.0, 2.7], "scale": 0.9, "seed": 5,
				"texture": "res://assets/props/plants/plant_palm.png", "width": 0.85, "height": 1.1},
			{"kind": "plant", "pos": [0.0, 0.0, -3.25], "scale": 0.75, "seed": 6,
				"texture": "res://assets/props/plants/plant_fern.png", "width": 0.7, "height": 0.85},
			# Seating — two benches only (path stays open)
			{"kind": "garden_bench", "pos": [-1.5, 0.0, -2.4], "yaw": 15.0, "seed": 0, "width": 1.4},
			{"kind": "garden_bench", "pos": [1.5, 0.0, 2.5], "yaw": -160.0, "seed": 1, "width": 1.3},
			# Door-wall plants (frame workshop door, no extra benches)
			{"kind": "plant", "pos": [-1.6, 0.0, 3.35], "scale": 0.7, "seed": 9,
				"texture": "res://assets/props/plants/plant_fern.png", "width": 0.65, "height": 0.75},
	...
	"kitchen": {
		...
		# Loop 110/228/234: denser diamond quarry (0.58 still large game tiles mid-FOV)
		"floor_uv_scale": 0.85,
		"ceiling_color": Color(0.72, 0.66, 0.56),
		# Loop 84: warm fill (range fire still carries orange) — less flat orange wash
		"light_energy": 1.0,
		"light_color": Color(1.0, 0.78, 0.52),
		"walls": {},
		"features": [
		...
		"props": [
			...
			{"kind": "dust_motes", "pos": [0.0, 0.0, 0.5], "amount": 18},
			...
			# Loop 152: few copper on floor — most pots hang on racks
			{"kind": "copper_pot", "pos": [-2.8, 0.0, 2.8], "scale": 1.0, "seed": 24},
			{"kind": "copper_pot", "pos": [2.6, 0.0, 2.9], "scale": 0.9, "seed": 26},
			# Loop 157: kitchen uses stool (not drawing-room formal chair cutout)
			{"kind": "stool", "pos": [2.0, 0.0, -1.0], "yaw": 100.0, "seed": 5},
			...
			# Loop 152: three wide trugs in corners (not barrel pile under sink)
			{"kind": "wicker_basket", "pos": [-3.5, 0.0, 0.3], "scale": 1.05, "seed": 0, "fill": "apples"},
			{"kind": "wicker_basket", "pos": [3.5, 0.0, 0.5], "scale": 0.95, "seed": 1, "fill": "linen"},
			{"kind": "wicker_basket", "pos": [3.2, 0.0, 2.0], "scale": 0.9, "seed": 3, "fill": "veg"},
			{"kind": "oil_lamp", "pos": [-2.6, 0.0, -2.2], "yaw": 30.0, "height": 0.9, "seed": 0},
			...
			{"kind": "oil_lamp", "pos": [2.8, 0.0, -2.9], "yaw": -5.0, "height": 0.9, "seed": 1},
			# Door approach clear of mid-path pots
