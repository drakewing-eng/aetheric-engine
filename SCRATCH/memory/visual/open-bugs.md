...
- **Side chair flat pad residual:** desk/balloon seats still green fridge pads mid-FOV. Cylinder-dominant soft seat + seed-1 cylinder-only balloon cushion (no flat slab). Art + door suite PASS.  
...
- **Aetheric posts residual:** slimmer iron/oak corner posts for more air. Art + door suite PASS.  
...
- **Umbrella stand churn residual:** pale cream ceramic milk-churn mid-FOV hall. Warm stoneware/oak urn taper + blue glaze + brass rim; crook sticks + furled canopy mass.  
- **Hall bud vase residual:** warmer ivory bottle + low bloom cluster (not pale cake). Art + door suite PASS.  
...
- **Oil lamp stick residual:** cream pencil columns on kitchen floor mid-FOV. Rewrote Argand — squat bulbous font, short stem, wide brass gallery, tapered chimney + 3-rod cage. Art + door suite PASS.  
...
- **Painting residual:** gilt/mahogany/ebony frames washout. Solid-mat/metal frames by style; oil canvas texture retained.  
- **Glass wall residual:** iron bars + stone sill washout. Solid-metal iron perimeter/mullions + solid-mat sill.  
- **Wall vine residual:** stems hit wood path. Solid-mat stems + leaf discs (no sphere_blob).  
