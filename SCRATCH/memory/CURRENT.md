...
**Updated:** 2026-07-30 ~overnight loop 190  
**HEAD:** (pending commit) visual loop 190  
...
| 4 | Unique Victorian objects | **ADVANCED 71–190** hall tree |
| 5 | Geometric / surface detail | **ADVANCED 72–190** turned post |
...
| 190 | **Plump flour bag** (not crate) + **hall tree** turned post/hooks + secondary machine amber terminals (not cyan hats) |
...
- Optional: hero aetheric cyan dome polish; umbrella stand; prep kit 1–3 polish  

## Anchors

- Door test: `scripts/test_door_transitions.gd`  
- Shots: `auto_loop_67/` … `auto_loop_190/`  
