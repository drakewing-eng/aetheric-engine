...
**Updated:** 2026-07-29 ~overnight loop 172  
**HEAD:** (pending) visual loop 172  
...
| 4 | Unique Victorian objects | **ADVANCED 71–172** pot |
...
| 12–23 | Conservatory / gallery / workshop densify | **ADVANCED 116–172** pot |
...
| 107 | Botanical terracotta pot (not cake) | **DONE 172** |
...
| 172 | **Botanical pot:** terracotta wide belly + blue glaze band + dense bloom crown (not white wedding-cake tiers) |
...
- Shots: `auto_loop_67/` … `auto_loop_172/`  
