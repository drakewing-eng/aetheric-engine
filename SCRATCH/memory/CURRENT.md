...
**Updated:** 2026-07-29 ~overnight loop 166  
**HEAD:** (pending) visual loop 166  
...
| 73–100 | Sofa…wing/tea cylinders | **DONE 138–165** |
| 101 | Conservatory table + thin folios | **DONE 166** |
...
| 166 | **Conservatory:** seed 6 botanical vase (not cube books). **Tables:** `_add_table_folio` thin leather + gilt; dress 1 stack uses folios. |
...
- Shots: `auto_loop_67/` … `auto_loop_166/`  
