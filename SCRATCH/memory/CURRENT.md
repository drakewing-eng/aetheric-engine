...
**Updated:** 2026-07-29 ~overnight loop 178  
**HEAD:** (pending) visual loop 178  
...
| 4 | Unique Victorian objects | **ADVANCED 71–178** bench |
...
| 178 | **Garden bench:** open iron ends + spindle back + oak seat slats (not black fridge slab); solid matte iron |
...
- Shots: `auto_loop_67/` … `auto_loop_178/`  
