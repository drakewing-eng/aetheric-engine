...
**Updated:** 2026-07-30 ~overnight loop 239  
**HEAD:** (pending commit loop 239)  
...
| 4 | Unique Victorian objects | **ADVANCED 71–239** furniture soft |
...
| 8 | Side-view mesh furniture | **ADVANCED 70–239** ottoman + wing |
...
- Optional residual: wing armchair still somewhat blocky mid-FOV (front/rear)  
- Optional residual: desk/balloon chair green pads  
...
- Architecture, machines, furniture, service textures advanced 208–239  
- Square chesterfield footstool now roll-dominant soft pillow mass  

## Anchors

- Door test: `scripts/test_door_transitions.gd`  
- Shots: `auto_loop_67/` … `auto_loop_239/`  
