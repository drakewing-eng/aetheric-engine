...
| 73–101 | Sofa…conservatory table | **DONE 138–166** |
| 102 | Door formal UX (not closet) | **DONE 167** |
...
| 166 | Conservatory botanical table; thin leather table folios |
| 167 | **Doors:** double leaves on wide openings; under-leaf warm glow; overdoor cornice; destination plaque + Label3D; prompt `[E] Enter · <room>`. |

## Still high-value if continuing

- Human E-door playtest confirmation (suite PASS; visual destination cues clearer)  
