...
| 8 | Side-view mesh furniture | **ADVANCED 70–118** settle |
...
| 53 | Copper vessels + pot rack + teak settle | **DONE 118** |
| 54 | Kitchen copper identity + butler sink | **DONE 119** |
...
| Loop | Work |
|------|------|
| 67–110 | Core density through floors/rugs/runners |
| 111–114 | Exteriors, chalk, armchair, looking-glass |
| 115–117 | Service walls, path/urns, stools/tables |
