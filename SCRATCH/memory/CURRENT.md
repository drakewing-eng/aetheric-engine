...
**Updated:** 2026-07-30 ~overnight loop 198  
**HEAD:** `pending` visual loop 198  
...
| 4 | Unique Victorian objects | **ADVANCED 71–198** chairs/stools |
| 5 | Geometric / surface detail | **ADVANCED 72–198** solid mats |
...
| 198 | **Side chair** + **stool** + **oil lamp** solid mats (no wood/velvet washout mid-FOV) |
...
- Optional: armchair/ottoman/side_table solid mats residual  

## Anchors

- Door test: `scripts/test_door_transitions.gd`  
- Shots: `auto_loop_67/` … `auto_loop_198/`  
