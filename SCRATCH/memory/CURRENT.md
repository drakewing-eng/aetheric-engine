...
**Updated:** 2026-07-30 ~overnight loop 208  
**HEAD:** (pending commit loop 208)  
...
| 5 | Geometric / surface detail | **ADVANCED 72–208** arch trim |
...
- **Architecture trim + portals:** solid mats (loop 208) — no pale `furniture_wood.jpg` washout on rails/skirting/portals  
...
- Shots: `auto_loop_67/` … `auto_loop_208/`  
