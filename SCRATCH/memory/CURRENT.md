...
**Updated:** 2026-07-30 ~overnight loop 235  
**HEAD:** `640d34e` visual loop 235  
...
- Architecture, machines, furniture, service textures advanced 208–235  
- Wood floors denser mid-FOV across principal rooms  

## Anchors

- Door test: `scripts/test_door_transitions.gd`  
- Shots: `auto_loop_67/` … `auto_loop_235/`  
