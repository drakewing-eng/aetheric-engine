...
**Updated:** 2026-07-30 ~overnight loop 236  
**HEAD:** (pending) visual loop 236  
...
| 4 | Unique Victorian objects | **ADVANCED 71–236** ottoman |
...
- Architecture, machines, furniture, service textures advanced 208–236  
- Ottomans: continuous low velvet mass (no multi-tier pale cake)  

## Anchors

- Door test: `scripts/test_door_transitions.gd`  
- Shots: `auto_loop_67/` … `auto_loop_236/`  
