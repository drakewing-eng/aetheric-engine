...
**Updated:** 2026-07-30 ~overnight loop 196  
**HEAD:** `d92ba27` visual loop 196  
...
| 4 | Unique Victorian objects | **ADVANCED 71–196** tool rack |
| 5 | Geometric / surface detail | **ADVANCED 72–196** solid mats |
...
| 123–130 | Pot rail…bookshelf solid mats | **DONE 188–195** |
| 131 | Tool rack + hall dress kits solid mats | **DONE 196** |
...
| 196 | **Tool rack** solid frame + iron/copper tools + **hall dress kits** 0/1/3 solid mats |
...
- Optional: kitchen range solid mats; chalk board polish; residual mid-FOV scan  

## Anchors

- Door test: `scripts/test_door_transitions.gd`  
- Shots: `auto_loop_67/` … `auto_loop_196/`  
